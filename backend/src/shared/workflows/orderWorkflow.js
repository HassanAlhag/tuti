const ORDER_STATUSES = ["Pending", "Confirmed", "Processing", "Ready for Delivery", "Shipped", "Delivered", "Customer Accepted", "Cancelled", "Refunded", "Disputed"];
const USER_ROLES = ["customer", "seller", "support", "admin", "driver"];
